...
var pizza:string[]=["Margherita Pizza","Pepperoni Pizza","Hawaiian Pizza"];
for(var pizaas in pizza){
    console.log("i like"+" "+pizza[pizaas]);
    
}
var Favoratepizza = ["Margherita Pizza", "Pepperoni Pizza", "Hawaiian Pizza"];
for(var pizaaas in Favoratepizza){
    console.log("i like"+" "+Favoratepizza[pizaaas]);
